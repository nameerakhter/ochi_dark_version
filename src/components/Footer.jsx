export default function Footer() {
  ...
  return (
    <div className="flex h-screen w-full gap-5 bg-zinc-900 p-20 text-white">
      <div className='font-["Neue Montreal Regular"] flex h-full w-1/2 flex-col justify-between'>
        <div className="heading">
          <h1 className="-mb-15 text-[7vw] font-semibold uppercase leading-none">
            EYE-
          </h1>
          <h1 className="-mb-10 text-[7vw] font-semibold uppercase leading-none">
            OPENING
          </h1>
        </div>
        <div className="ochi">
      ...
      <div className='font-["Neue Montreal Regular"] flex h-full w-1/2 flex-col justify-between'>
        <h1 className="-mb-10 text-[6vw] font-semibold uppercase leading-none">
          PRESENTATIONS
        </h1>
        <div className="flex justify-between">
          <div>
            ...
            {socials.S.map((social) => (
              <a key={social} href="#" className="mb-2 block underline">
                {social}
              </a>
            ))}
          </div>
          <div>
            ...
            {socials.L.map((location) => (
              <p key={location} className="mb-4 whitespace-pre-line">
                {location}
              </p>
            ))}
          </div>
          <div>
            ...
            <a href={`mailto:${socials.E}`} className="underline">
              {socials.E}
            </a>
          </div>
          <div>
            ...
            {socials.M.map((item) => (
              <a key={item} href="#" className="mb-2 block underline">
                {item}
              </a>
            ))}
          </div>
