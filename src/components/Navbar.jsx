...
export default function Navbar() {
  ...
  return (
    <div className="fixed z-[999] w-full text-white shadow-md font-['Neue Montreal Regular']">
      ...
      <svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Navigation Items */}
        <div
          className={`absolute sm:relative top-16 sm:top-0 left-0 sm:left-auto w-full sm:w-auto text-white sm:bg-transparent sm:flex flex-col sm:flex-row items-center gap-4 sm:gap-10 transition-all duration-300 ${
        ...
        >
          {["Services", "Work", "About", "Insights", "Contact"].map(
            (item, index) => (
              <a
                key={index}
                className={`block sm:inline-block text-lg sm:text-base hover:text-gray-700 cursor-pointer ${
                  index === 4 ? "sm:ml-32" : ""
                }`}
              >
                {item}
